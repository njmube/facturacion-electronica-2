...
public class AfipWsaaClient {
	...
	public static String invoke_wsaa(byte[] LoginTicketRequest_xml_cms,
			String endpoint) throws RemoteException, ServiceException,
	...
	//
	public static byte[] create_cms(String p12file, String p12pass,

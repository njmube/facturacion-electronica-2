...
public class ComprobanteProveedorBOImpl implements ComprobanteProveedorBO {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(ComprobanteProveedorBOImpl.class);
	private FacturacionService facturacionService;
	private ComprobanteProveedorDAO comprobanteProveedorDAO;
	private ProveedorDAO proveedorDAO;
	private ParametroDAO parametroDAO;

	public ComprobanteProveedorBOImpl() {
		facturacionService = AbstractFactory
				.getInstance(FacturacionService.class);
		comprobanteProveedorDAO = ar.com.wuik.sistema.utils.AbstractFactory
				.getInstance(ComprobanteProveedorDAO.class);
		proveedorDAO = ar.com.wuik.sistema.utils.AbstractFactory
				.getInstance(ProveedorDAO.class);
	...
	public Comprobante obtener(Long id) throws BusinessException {
		try {
			return comprobanteProveedorDAO.getById(id);
	...
	@Override
	public List<Comprobante> buscar(ComprobanteProveedorFilter filter)
			throws BusinessException {
		try {
			return comprobanteProveedorDAO.search(filter);
		} catch (DataAccessException daexc) {
	...
	public void guardar(Comprobante comprobanteAfip) throws BusinessException {
		try {
			...
			comprobanteProveedorDAO.saveOrUpdate(comprobanteAfip);
	...
	public void guardarRegistrarAFIP(Comprobante comprobante)
		...
		try {
			...
			comprobanteProveedorDAO.saveOrUpdate(comprobante);
			HibernateUtil.commitTransaction();
	...
	private FEV1.dif.afip.gov.ar.entities.Comprobante crearComprobante(
		...
		Proveedor proveedor= proveedorDAO.getById(comprobante.getIdProveedor());
		long nrocomprobante = Long.valueOf(comprobante.getNroComprobante());

		String documento = proveedor.getCuit().replaceAll("-", "");
		...
		//comprobanteAfip.setDocTipo(getTipoDocumento(proveedor.getTipoDocumento()));
...
//	}
	...
	@Override
	public void actualizar(Comprobante comprobante) throws BusinessException {

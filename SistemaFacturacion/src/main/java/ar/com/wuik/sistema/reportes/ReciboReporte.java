...
//			throw new ReportException(bexc, "Error al obtener Factura");
	...
	private static ReciboDTO createDummy() {
		ReciboDTO reciboDTO = new ReciboDTO(); 
		reciboDTO.setBancoCh1("SANTANDER RIO");
		reciboDTO.setNroCh1("001-23156");
		reciboDTO.setTotalCh1(BigDecimal.valueOf(126789.22));
		reciboDTO.setTotal(BigDecimal.valueOf(126789.22));
		reciboDTO.setTotalLetras(MonedaUtils.enLetras(reciboDTO.getTotal()) + " --------------------------");
		return reciboDTO;
	}

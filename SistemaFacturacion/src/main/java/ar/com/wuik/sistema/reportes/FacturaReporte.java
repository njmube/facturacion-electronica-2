...
public class FacturaReporte {
	...
	public static void generarFactura(Long idFactura) throws Exception {
		...
		parameters.put("BG_IMG", FacturaReporte.class.getResourceAsStream("/reportes/bg-comprobante.png"));
		...
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport,
				parameters, new JRBeanCollectionDataSource(detalles));

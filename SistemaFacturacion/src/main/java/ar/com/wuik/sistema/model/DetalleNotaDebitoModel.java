...
public class DetalleNotaDebitoModel extends WTableModel<DetalleNotaDebito> {
	...
	@Override
	protected Object[] getRow(DetalleNotaDebito t, Object[] fila) {

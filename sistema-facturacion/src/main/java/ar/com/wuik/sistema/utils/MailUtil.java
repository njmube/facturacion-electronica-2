...
public class MailUtil {
	...
	public static void sendMailAttachment(String file) throws Exception {
	...
	public static void sendFacturaMail(String file, String mailTo)  throws Exception {
		try {
			...
			message.setSubject("COPIA DE FACTURA");
			...
			LOGGER.error("Error al enviar Mail a '" + mailTo + "'", mexc);
			throw new Exception("Error al enviar Mail a '" + mailTo + "' verifique si es válido y vuelva a intentar", mexc);
		}
	}
